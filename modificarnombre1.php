...
<div style="margin-top:10%;margin-left:30%;border:2px solid black;background-color:burlywood;width:30%;padding:1%">
    <form action="modificarnombre2.php" method="post">
        <span> INGRESAR NOMBRE A MODIFICAR:</span><br><br>
        <input type="text" class="form-control" style="margin-bottom: -2%;" name="nota_nueva" value="<?php echo $reg['nombre'] ?>"><br><br>
        <input type="hidden" name="nota" value="<?php echo $reg['nombre'] ?>">
