    ...
    <table
        ...
        <tbody>
            <tr class="table table-primary">
                <td scope="row" class="modulo">MF0750_1: Construcción  de una aplicacion asp.net core</td>
                <td>210 horas</td>
                <td id="demo1"></td>
            </tr>
            <tr class="table table-primary">
                <td scope="row"  class="modulo">MF0751_2: Funcionamiento de modelo-controlador-vista</td>
                <td>180 horas</td>
                <td id="demo2"></td>
            </tr>
            <tr class="table table-primary">
                <td scope="row"  class="modulo">MF0752_3: Publicación de páginas web asp.net core</td>
                <td>90 horas</td>
                <td id="demo3"></td>
            </tr>
        </tbody>
